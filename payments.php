...
<main>
    <section class="welcome-section ">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 class="section-main-title theme-color mb-0">Payments</h1>
                </div>
                <div class="col-12">
                    <div class="booking-charge-tabel-area">
                        <div class="section-sb-title-area">
                            <div class="">
                                <h2 class="section-sb-title">Payments</h2>
                            </div>
                            <div class="">
                                <div class="dropdown">
                        ...
                        <div class="payment-method-tabs">
                            <ul class="payment-tabs-btn-area">
                                <li class="payment-tabs-btn active" data-tab-target="#credit-cart">
                                    <button type="button" class="payment-btn">
                                        <span class="right-circle"><i class="fa-solid fa-check"></i></span>
                                        Credit Card
                                    </button>
                                </li>
                                <li class="payment-tabs-btn" data-tab-target="#payPal">
                                    <button type="button" class="payment-btn">
                                        <span class="right-circle"><i class="fa-solid fa-check"></i></span>
                                        PayPal
                                    </button>
                                </li>
                                <li class="payment-tabs-btn" data-tab-target="#bank-account">
                                    <button type="button" class="payment-btn">
                                        <span class="right-circle"><i class="fa-solid fa-check"></i></span>
                                        Bank Account
                                    </button>
                        ...
                        <div id="credit-cart" data-tab-content class="card-area active">
                            ...
                            <h2 class="add-payment-title">Add Another Payment Method</h2>
                            <form>
                                <div class="form-container">
                                    <div class="field-container">
                                        <label class="payment-label" for="name">Name</label>
                                        <input class="payment-method-input"  placeholder="Name" id="name" maxlength="20" type="text">
                                    </div>
                                    <div class="field-container">
                                        <label class="payment-label" for="cardnumber">Card Number</label>
                                        <!-- <span id="generatecard">generate random</span> -->
                                        <input class="payment-method-input" placeholder="0000 - 0000 - 0000 - 0000" id="cardnumber" type="text" pattern="[0-9]*" inputmode="numeric">
                                    ...
                                    <div class="field-container">
                                        <label class="payment-label" for="expirationdate">Expiration</label>
                                        <input class="payment-method-input" placeholder="MM/YY" id="expirationdate" type="text" pattern="[0-9]*" inputmode="numeric">
                                    </div>
                                    <div class="field-container">
                                        <label class="payment-label" for="securitycode">CVV/CVC</label>
                                        <input class="payment-method-input" placeholder="000" id="securitycode" type="text" pattern="[0-9]*" inputmode="numeric">
                                    </div>
                                </div>
                                <div class="">
                                    <button type="button" class="theme-btn">Add Card</button>
                                </div>
                            </form>
                        </div>

                        <div id="payPal" data-tab-content class="card-area"></div>
                        <div id="bank-account" data-tab-content class="card-area"></div>
                    </div>
                </div>
            </div>
        </div>
